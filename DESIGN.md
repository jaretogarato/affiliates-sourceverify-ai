...
- Coral (#f25d5d) + orange (#fc4c02) brand accents in illustrations only
...
### Primary
- **Brand Coral** (`#f25d5d`): The primary brand accent — a warm coral used in gradient illustrations and the highest-signal brand moments. Hover: `#e04d4d`. Never used as UI chrome.
...
### Don't
- Don't use Brand Coral (#f25d5d) or Brand Orange (#fc4c02) as UI colors — they're for illustrations only
...
- Brand Accent 1: "Brand Coral (#f25d5d)"
