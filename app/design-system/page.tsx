...
function sectionNumber(n: string) {
  return (
    <span style={{ ...monoLabel(11), color: "#00000066" }}>{n} /&nbsp;</span>
  );
}
    ...
    <div style={{ fontFamily: FONT_PRIMARY, background: "#ffffff" }}>
      ...
      >
        ...
        >
          Design System{" "}
          <br />
          <span style={{ color: "#00000066" }}>Inspired by Together AI</span>
        </h1>
        <p
      ...
      >
        <p style={{ ...monoLabel(), color: "#00000066", marginBottom: "8px" }}>
          ...
          {[
            ...
            >
              ...
              <div style={{ padding: "16px" }}>
                ...
                <p style={{ ...monoLabel(10, 400, "0.05px"), color: "#00000066" }}>
                  {c.hex}
                </p>
                <p
                  className="mt-1"
                  style={{ fontSize: "14px", color: "#00000066" }}
                >
                  {c.desc}
                </p>
              </div>
          ...
          {[
            ...
            >
              ...
              <div style={{ padding: "12px 16px" }}>
                ...
                <p
                  className="mt-1"
                  style={{ fontSize: "13px", color: "#00000066" }}
                >
                  {c.desc}
                </p>
              </div>
      ...
      >
        ...
        <div className="flex flex-wrap items-center gap-4 mb-10">
          ...
          <div className="text-center">
            ...
            <p
              className="mt-2"
              style={{ ...monoLabel(10, 400, "0.05px"), color: "#00000066" }}
            >
              DARK SOLID CTA
            </p>
          </div>
      ...
      >
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-3 mb-10">
          ...
          >
            <p style={{ ...monoLabel(10, 400, "0.05px"), color: "#00000066", marginBottom: "12px" }}>
              CONTAINED
            </p>
            <h3
              style={{
            ...
            <p style={{ fontSize: "14px", color: "#00000066", lineHeight: 1.4 }}>
          ...
          >
            <p style={{ ...monoLabel(10, 400, "0.05px"), color: "#bdbbff", marginBottom: "12px" }}>
              ACCENT
            </p>
            <h3
              style={{
      ...
      >
        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2">
          <div className="text-center">
            ...
            <p style={{ fontSize: "14px", color: "#00000066" }}>
              Buttons, badges, tags
            </p>
          </div>
          <div className="text-center">
        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <div className="mt-3">
              ...
              <p style={{ fontSize: "13px", color: "#00000066" }}>
